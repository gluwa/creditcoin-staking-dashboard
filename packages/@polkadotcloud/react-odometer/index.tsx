...
(function () {
    var COUNT_FRAMERATE, COUNT_MS_PER_FRAME, DIGIT_FORMAT, DIGIT_HTML, DIGIT_SPEEDBOOST, DURATION, FORMAT_MARK_HTML, FORMAT_PARSER, FRAMERATE, FRAMES_PER_VALUE, MS_PER_FRAME, MutationObserver, Odometer, RIBBON_HTML, TRANSITION_END_EVENTS, TRANSITION_SUPPORT, VALUE_HTML, addClass, createFromHTML, fractionalPart, now, removeClass, requestAnimationFrame, round, transitionCheckStyles, trigger, truncate, _old, _ref, _ref1, __slice = [].slice;
    ...
    fractionalPart = function (val) { return val - round(val); };
    Odometer = (function () {
                    ...
                    if (this.el[property] != null) {
                        (function (property) {
                            return Object.defineProperty(_this.el, property, {
                                ...
                                set: function (val) { return _this.update(val); },
                            });
                        })(property);
                    }
                }
    ...
    setTimeout(function () {
        ...
        if (window.odometerOptions) {
            ...
            for (k in _ref1) {
                v = _ref1[k];
                _results.push((_base = Odometer.options)[k] != null
    ...
    if (((_ref1 = document.documentElement) != null ? _ref1.doScroll : void 0) !=
        null &&
    ...
    if (typeof define === "function" && define.amd) {
        define([], function () { return Odometer; });
    }
...
var Odometer$1 = Odometer;

var ReactOdometer = function (_a) {
    var duration = _a.duration, value = _a.value, decimals = _a.decimals;
    var ref = useRef(null);
    var odometer = useRef(null);
    var instantiated = useRef(false);
    useEffect(function () {
        if (!instantiated.current && ref.current) {
            instantiated.current = true;
            odometer.current = new Odometer$1({
                el: ref.current,
                value: value,
                duration: duration,
                format: "(,ddd).".concat("d".repeat(decimals || 12)),
                theme: "minimal",
            });
        }
    }, [ref.current]);
    useEffect(function () {
        var _a, _b;
        if (((_a = odometer.current) === null || _a === void 0 ? void 0 : _a.value) !== value) {
            (_b = odometer.current) === null || _b === void 0 ? void 0 : _b.update(value);
        }
    }, [value]);
    return (jsx(Fragment, { children: jsx("div", { ref: ref }) }));
};

export { ReactOdometer };
